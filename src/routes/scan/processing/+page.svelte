...
<svelte:head>
	<title>Processing Receipt · ExpenseTracker</title>
</svelte:head>

<main class="ds-shell">
	<div
		class="ds-content d-flex flex-column justify-content-center align-items-center"
		style="min-height:100dvh;"
	>
		<div class="ds-illustration-receipt" aria-hidden="true">
			<div class="top"></div>
			<div class="dot"></div>
		</div>
